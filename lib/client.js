...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var STYLE_TEXT = [
      ...
      '.am-panel-sub{display:flex;align-items:center;gap:8px;min-width:0}',
